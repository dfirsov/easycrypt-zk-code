...
axiom perm_d_in1 p n w : p \in perm_d n => perm_eq w (range 0 n) => p \o (mk_perm w) \in perm_d n.
axiom perm_d_in2 p n w : p \in perm_d n => perm_eq w (range 0 n) => p \o (inv (mk_perm w)) \in perm_d n.
