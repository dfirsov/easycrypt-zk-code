...
(* apply (sim1_rew_ph V _ _ _ x). *) admit. (* apply V_summitup_ll. apply V_challenge_ll. *)
(* apply (rewindable_A_plus V). apply rewindable_V_plus. *)


progress.
apply (sim1_prop V D  _ _  _ _ _  &m0 p w  _ );auto.  apply (rewindable_A_plus V). apply rewindable_V_plus. 
apply D_guess_ll. apply V_summitup_ll. apply V_challenge_ll. smt (negl2_prop).
progress.
apply (sim1assc V D _ _ _ _ _ &m0 stat0 _).  apply (rewindable_A_plus V). apply rewindable_V_plus. apply D_guess_ll. apply V_summitup_ll.
apply V_challenge_ll. apply negl2_prop. admit.
auto.
qed.
